...
vignette: >
  %\VignetteIndexEntry{Introduction to ciecl (English)}
...
The package includes **39,873 ICD-10 codes** from the official MINSAL/DEIS v2018 catalog,
...
- DEIS Repository: <https://repositoriodeis.minsal.cl>
